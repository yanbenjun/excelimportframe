...
public class XlsxSheetReadHandler extends DefaultHandler
{
     ...
     * 从文件里提取出内容后的第一个处理器
     */
    private AbstractFileParseHandler fileParseHandler;
    ...
    XlsxSheetReadHandler(ToParseFile toParseFile, AbstractFileParseHandler fileParseHandler, SharedStringsTable sst) {
    ...
    private void compute(List<ColumnEntry> dataRow, boolean lastRow) throws RowHandleException
    {
        ...
        fileParseHandler.processOne(prow, new RowParseMessage(this.row - 1));
    }
