...
public class XmlHandler extends DefaultHandler
{
    ...
    public XmlHandler(String rowTag, ToParseFile toParseFile, AbstractFileParseHandler fileParseHandler)
    {
    ...
    private void compute(ParsedRow parsedRow, boolean lastRow) throws RowHandleException
    {
        ...
        fileParseHandler.processOne(parsedRow, new RowParseMessage(0));
    }
