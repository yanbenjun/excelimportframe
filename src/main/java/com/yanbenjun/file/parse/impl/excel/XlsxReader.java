package com.yanbenjun.file.parse.impl.excel;
...
import com.yanbenjun.file.parse.impl.validate.HeadParseException;
...
public class XlsxReader extends AbstractReader
{
    ...
    public XlsxReader(BaseParseFileInfo baseFileInfo,AbstractFileParseHandler fileParseHandler)
    {
    ...
    private ParseMessage parseWithPriority() throws Exception
    {
        ...
        XlsxSheetReadHandler handler = new XlsxSheetReadHandler(toParseFile, fileParseHandler,sst);
